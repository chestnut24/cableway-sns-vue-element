...
@Component({
  selector: 'app-middle-drive',
  templateUrl: './middle-drive.component.html',
  styleUrls: ['./middle-drive.component.scss']
})
export class MiddleDriveComponent implements OnInit {
