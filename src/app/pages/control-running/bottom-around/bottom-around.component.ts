...
@Component({
  selector: 'app-bottom-around',
  templateUrl: './bottom-around.component.html',
  styleUrls: ['./bottom-around.component.scss']
})
export class BottomAroundComponent implements OnInit {
