...
@Component({
    selector: 'app-speed-elect-top-station',
    templateUrl: './speed-elect-top-station.component.html',
    styleUrls: ['./speed-elect-top-station.component.scss']
})
export class SpeedElectTopStationComponent implements OnInit {
    isVisible = false;
    ...
    motorList = ['上站1#主电机', '上站2#主电机', '上站3#主电机', '上站4#主电机', '上站5#主电机', '上站6#主电机', '上站7#主电机', '上站8#主电机'];
    motorDataList = [];
    ...
    get runStateData() {
        return this.mqttService.dataDictionary['上站运行状态'] ? this.mqttService.dataDictionary['上站运行状态'] : {};
    }
