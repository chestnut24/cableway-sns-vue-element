...
@Component({
  selector: 'app-overview-top-station',
  templateUrl: './overview-top-station.component.html',
  styleUrls: ['./overview-top-station.component.scss']
})
export class OverviewTopStationComponent implements OnInit {
